...
class ConcurrencyVector {
 public:
  ...
  TreeNode &EmplaceBack(int task_id, NodeType type, int depth, int nth_child, int preceeding_taskwait, TreeNode *parent) {
    ...
    //                                    parent);
    begin_[step_index] = {task_id, step_index, type, depth, 0, nth_child, preceeding_taskwait, parent, nullptr, nullptr, nullptr, nullptr};
